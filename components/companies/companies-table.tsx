        ...
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    if (!website) return <span className="text-muted-foreground text-sm">No website</span>
                    return (
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{row.getValue("activeDealCount") || 0}</span>
                    </div>
                ),
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    return <span className="font-medium">${((value || 0) / 1000).toFixed(0)}K</span>
                },
            },
            {
                    ...
                    return (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => onCompanySelect(company._id)}>View details</DropdownMenuItem>
                                <DropdownMenuItem>Edit company</DropdownMenuItem>
                                <DropdownMenuSeparator />
                                <DropdownMenuItem>Create deal</DropdownMenuItem>
                                <DropdownMenuItem>Add contact</DropdownMenuItem>
                                <DropdownMenuItem className="text-destructive" onClick={() => handleDeleteCompany(company._id)}>
                                    Delete
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
