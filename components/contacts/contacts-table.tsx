    ...
    const columns: ColumnDef<Contact>[] = useMemo(
        () => [
                    ...
                    return (
                        <div className="flex items-center gap-3">
                            <Avatar className="w-8 h-8">
                                <AvatarImage src={`/placeholder-icon.png?height=32&width=32&text=${contact.firstName.charAt(0)}`} />
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    const lastActivity = row.getValue("lastActivity") as number | undefined
                    return (
                        <div className="flex items-center gap-2">
                            <Calendar className="w-4 h-4 text-muted-foreground" />
                            <span className="text-sm">{lastActivity ? new Date(lastActivity).toLocaleDateString() : "—"}</span>
                        </div>
                    )
                },
            },
                    ...
                    return (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => onContactSelect(contact)}>View details</DropdownMenuItem>
                                <DropdownMenuItem>Edit contact</DropdownMenuItem>
                                <DropdownMenuSeparator />
                                <DropdownMenuItem>Create deal</DropdownMenuItem>
                                <DropdownMenuItem>Send email</DropdownMenuItem>
                                <DropdownMenuItem className="text-destructive" onClick={() => handleDeleteContact(contact._id)}>
                                    Delete
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
